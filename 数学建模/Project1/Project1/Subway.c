...
void in_quiry(GraphType *G)   //查询站点信息
{
	int n;
	printf("您想查询的景点编号为：");
	scanf("%d", &n);
...
void shortest(GraphType *G, int P[][MAX], int D[][MAX]) //最短路径
{
	...
	scanf("%d%d", &m, &n);
	fflush(stdin);
	printf("%s与%s之间最少经过%d个站台\t预计耗时%d分钟\n", G->vertexs[m].name, G->vertexs[n].name, D[m][n],D[m][n]*3);
	if (m<n)
	{
...
void allpath(GraphType *G, AdjList *g, int m, int n, int path[], int d) //两景点间所有路径
{
	...
	if (m == n&&d >= 1)
	{
		...
		t = d * 3;
		printf("\n 您所需要经过的站点数为：count = %d个站台\t票价为：fare = %d元\t所需时间：time = %d分钟\n\n", d,r,t);
...
GraphType *create(GraphType *G)  //创建无向图
{
	...
	else
	{
		...
		strcpy(G->vertexs[161].name, "64【春明门】");
		...
		strcpy(G->vertexs[167].introduction, "⑥号线与①号线换乘站");
		...
		G->arcs[36][37].adj = G->arcs[37][36].adj = G->arcs[37][14].adj = G->arcs[14][37].adj = G->arcs[14][39].adj = G->arcs[39][14].adj = G->arcs[39][40].adj = G->arcs[40][39].adj = G->arcs[40][41].adj = G->arcs[41][40].adj = 1;
		...
		G->arcs[60][61].adj = G->arcs[61][60].adj = G->arcs[61][18].adj = G->arcs[18][61].adj = G->arcs[18][63].adj = G->arcs[63][18].adj = G->arcs[63][64].adj = G->arcs[64][63].adj = G->arcs[64][65].adj = G->arcs[65][64].adj = 1;
		G->arcs[65][66].adj = G->arcs[66][65].adj = G->arcs[66][67].adj = G->arcs[67][66].adj = G->arcs[67][68].adj = G->arcs[68][67].adj = G->arcs[68][43].adj = G->arcs[43][68].adj = G->arcs[43][70].adj = G->arcs[70][43].adj = 1;
		...
		G->arcs[84][32].adj = G->arcs[32][84].adj = G->arcs[32][86].adj = G->arcs[86][32].adj = G->arcs[86][87].adj = G->arcs[87][86].adj = G->arcs[87][88].adj = G->arcs[88][87].adj = G->arcs[88][89].adj = G->arcs[89][88].adj = 1;
		G->arcs[89][90].adj = G->arcs[90][89].adj = G->arcs[90][91].adj = G->arcs[91][90].adj = G->arcs[91][92].adj = G->arcs[92][91].adj = G->arcs[92][93].adj = G->arcs[93][92].adj = G->arcs[93][15].adj = G->arcs[15][93].adj = 1;
		G->arcs[15][95].adj = G->arcs[95][15].adj = G->arcs[95][96].adj = G->arcs[96][95].adj = G->arcs[96][97].adj = G->arcs[97][96].adj = G->arcs[97][98].adj = G->arcs[98][97].adj = G->arcs[98][68].adj = G->arcs[68][98].adj = 1;
		G->arcs[68][100].adj = G->arcs[100][68].adj = G->arcs[100][101].adj = G->arcs[101][100].adj = G->arcs[101][102].adj = G->arcs[102][101].adj = G->arcs[102][103].adj = G->arcs[103][102].adj = G->arcs[103][104].adj = G->arcs[104][103].adj = 1;
		...
		G->arcs[128][41].adj = G->arcs[41][128].adj = G->arcs[41][130].adj = G->arcs[130][41].adj = G->arcs[130][97].adj = G->arcs[97][130].adj = G->arcs[97][132].adj = G->arcs[132][97].adj = G->arcs[132][133].adj = G->arcs[133][132].adj = 1;
		G->arcs[133][66].adj = G->arcs[66][133].adj = G->arcs[66][135].adj = G->arcs[135][66].adj = G->arcs[135][136].adj = G->arcs[136][135].adj = G->arcs[136][137].adj = G->arcs[137][136].adj = G->arcs[137][138].adj = G->arcs[138][137].adj = G->arcs[138][139].adj = G->arcs[139][138].adj = 1;
		...
		G->arcs[150][151].adj = G->arcs[151][150].adj = G->arcs[151][152].adj = G->arcs[152][151].adj = G->arcs[152][72].adj = G->arcs[72][152].adj = G->arcs[72][126].adj = G->arcs[126][72].adj = G->arcs[126][155].adj = G->arcs[155][126].adj = 1;
		G->arcs[155][156].adj = G->arcs[156][155].adj = G->arcs[156][157].adj = G->arcs[157][156].adj = G->arcs[157][39].adj = G->arcs[39][157].adj = G->arcs[39][95].adj = G->arcs[95][39].adj = G->arcs[95][160].adj = G->arcs[160][95].adj = 1;
		G->arcs[160][64].adj = G->arcs[64][160].adj = G->arcs[64][162].adj = G->arcs[162][64].adj = G->arcs[162][163].adj = G->arcs[163][162].adj = G->arcs[163][164].adj = G->arcs[164][163].adj = G->arcs[164][165].adj = G->arcs[165][164].adj = 1;
		G->arcs[165][166].adj = G->arcs[166][165].adj = G->arcs[166][23].adj = G->arcs[23][166].adj = 1;
