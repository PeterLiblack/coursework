...
GraphType *create(GraphType *G)  //创建无向图
{
	...
	else
	{
		...
		strcpy(G->vertexs[103].name, "航天大道");
		...
		strcpy(G->vertexs[106].name, "神州大道");
		...
		strcpy(G->vertexs[107].name, "航天东路");
		...
		strcpy(G->vertexs[123].name, "汉城南路");
		...
		strcpy(G->vertexs[125].name, "高新四路");
		...
		strcpy(G->vertexs[126].name, "劳动南路");
		...
		strcpy(G->vertexs[139].name, "纺织城火车站");
		...
		strcpy(G->vertexs[142].name, "纬二十八路");
		...
		strcpy(G->vertexs[143].name, "纬十八路");
		...
		strcpy(G->vertexs[144].name, "西部大道");
		...
		strcpy(G->vertexs[145].name, "锦业二路");
		...
		strcpy(G->vertexs[147].name, "丈八六路");
		...
		strcpy(G->vertexs[148].name, "丈八四路");
		...
		strcpy(G->vertexs[149].name, "丈八一路");
		...
		strcpy(G->vertexs[150].name, "省游泳馆");
		...
		strcpy(G->vertexs[152].name, "科技四路");
		...
		strcpy(G->vertexs[154].name, "劳动南路");
		...
		strcpy(G->vertexs[156].name, "西关正街");
		...
		strcpy(G->vertexs[160].name, "东关正街");
		...
		strcpy(G->vertexs[162].name, "万寿南路");
